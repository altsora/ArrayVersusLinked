...
public class RemoveByIndexOperation extends IndexList {
    public RemoveByIndexOperation(int capacity, TimeUnit timeUnit) {
    ...
    protected Result calc(int capacity, TimeUnit timeUnit, Place place, int index) {
        ...
        return Result.builder()
                .operationType(OperationType.REMOVE_BY_INDEX)
